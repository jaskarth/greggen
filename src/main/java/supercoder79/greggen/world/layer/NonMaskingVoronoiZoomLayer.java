...
public class NonMaskingVoronoiZoomLayer extends GenLayer {
    public NonMaskingVoronoiZoomLayer(long p_i2133_1_, GenLayer p_i2133_3_) {
        super(p_i2133_1_);
    ...
    public int[] getInts(int x, int z, int width, int height) {
        ...
        int[] aint2 = IntCache.getIntCache(width * height);

        for (l2 = 0; l2 < height; ++l2) {
            System.arraycopy(aint1, (l2 + (z & 3)) * i2 + (x & 3), aint2, l2 * width, width);
        }
